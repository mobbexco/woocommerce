...
class WC_Gateway_Mobbex extends WC_Payment_Gateway
{
    ...
    {
        $this->logger->debug('debug', 'gateway > process_payment | Creating payment', compact('order_id'));
        ...
        $this->logger->debug('debug', 'gateway > process_payment | Checkout response', $checkout_data);
